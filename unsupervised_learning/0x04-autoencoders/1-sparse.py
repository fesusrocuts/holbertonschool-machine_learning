#!/usr/bin/env python3
"""
1. Sparse Autoencoder mandatory
...
def sparse(input_dims, hidden_layers, latent_dims, lambtha):
    """fn that creates a sparse autoencoder"""
    ...
    for i in range(len(hidden_layers)):
        ...
        if i == 0:
            ...
            z_mean = layer(z_mean)
    # rewrite layer
    layer = K.layers.Dense(units=latent_dims, activation='relu', activity_regularizer=K.regularizers.l1(lambtha))
    z_mean = layer(z_mean)
